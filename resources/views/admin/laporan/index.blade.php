    ...
    <div class="row justify-content-center">
        ...
        @if (session('message'))
            ...
            <div class="card">
                ...
                <a href="{{route('laporan.create')}}" class="float-right btn btn-outline-primary">Tambah Data(+)</a>
            </div>
                      ...
                      <th scope="col">No</th>
                                    ...
                                    @foreach($laporan as $data)
                                        ...
                                        <tr>
                                            ...
                                            @method('DELETE')
                                            <center>
                                                <a href="{{route('laporan.edit',$data->id)}}" class="btn btn-outline-primary btn-sm"><i class="fas fa-edit"></a></i>
